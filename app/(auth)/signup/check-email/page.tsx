  ...
  return (
    <div className="relative w-full max-w-md animate-scale-in">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-border bg-canvas-elevated/80 p-10 text-center backdrop-blur-2xl shadow-xl">
        <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-gold-300 to-gold-500 shadow-glow">
          <MailCheck className="h-6 w-6 text-white" />
        </div>
        <h1 className="ds-display mb-2 text-2xl font-bold">تحقق من بريدك</h1>
